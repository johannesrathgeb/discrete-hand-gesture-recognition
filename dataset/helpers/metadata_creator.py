...
def emgepn612(dataset_dir, data_subfolder, save_location, use_testing=False):
        ...
        for file in files:
            ...
            if os.path.isfile(file_path):
                with open(file_path, 'r', encoding='utf-8') as f:
                            ...
                            if "testingSamples" in user_data and use_testing:
...
if __name__ == '__main__':
    ...
    #get_max_length('raw_data/EMG-EPN612/', 'trainingJSON/') # Training --> 599 76
    #get_max_length('raw_data/EMG-EPN612/', 'testingJSON/') # Testing --> 599 76